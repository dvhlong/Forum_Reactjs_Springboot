...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    Page<Post> findAllByIsdeletedAndIsapprovedOrderByCreatedatDesc(boolean isDeleted, boolean isApproved,
            Pageable pageable);

    Page<Post> findAllByCreatedaccAndIsdeletedAndIsapproved(long createdUserId, boolean isDeleted, boolean isApproved,
            Pageable pageable);
    ...
    Page<Post> findAllByTopicAndIsdeletedAndIsapprovedOrderByCreatedatDesc(Topic topic, boolean isDeleted,
